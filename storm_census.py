...
plt.contourf(lonproj, latproj, Nc, 24, cmap=plt.cm.hot_r)
...
plt.subplot(2,2,3)
proj.drawcoastlines(linewidth=0.5)
plt.contourf(lonproj, latproj, Na, 24, cmap=plt.cm.hot_r)
...
plt.subplot(2,2,1)
proj.drawcoastlines(linewidth=0.5)
plt.contourf(lonproj, latproj, genc, 24, cmap=plt.cm.hot_r)
plt.title('Count of cyclone genesis')
H = plt.colorbar()
H.set_label('count')
plt.subplot(2,2,2)
proj.drawcoastlines(linewidth=0.5)
plt.contourf(lonproj, latproj, termc, 24, cmap=plt.cm.hot_r)
plt.title('Count of cyclone termination')
H = plt.colorbar()
H.set_label('count')
plt.subplot(2,2,3)
proj.drawcoastlines(linewidth=0.5)
plt.contourf(lonproj, latproj, gena, 24, cmap=plt.cm.hot_r)
plt.title('Count of anticyclone genesis')
H = plt.colorbar()
H.set_label('count')
plt.subplot(2,2,4)
proj.drawcoastlines(linewidth=0.5)
plt.contourf(lonproj, latproj, terma, 24, cmap=plt.cm.hot_r)
